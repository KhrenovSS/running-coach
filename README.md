...
- [x] Гибридный ИИ-коуч — **в проде** (C0–C9 + «Разбор v2» D0–D8 закрыты 25.08.2026; далее — недельный план #269, метрики разбора M1/M2.2 #268, сон из скриншота #257, пакет гигиены — 28–30.08.2026). Актуальная дорожная карта — [`docs/coach/DEV_PLAN.md`](docs/coach/DEV_PLAN.md)
...
**сон из скриншота** (`/sleep` → мост `/vision` → `DailyMetrics`), пакет гигиены. Актуальные
статусы — в `docs/coach/DEV_PLAN.md`.
