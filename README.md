...
Система анализирует тренировки, загруженные из Garmin (TCX-файлы), определяет тип бега (интервальная, темповая, восстановительная, длительная), отслеживает пульсовые зоны, набор высоты, погодные условия и динамику веса. В будущем — рекомендации тренировок на основе накопленной статистики.
...
- **Загрузка TCX** — парсинг файлов Garmin (дистанция, пульс, высота, GPS)
