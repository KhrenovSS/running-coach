...
> и отложенные фичи #5/#6/#8–#13/#15. Исторический аудит — `docs/archive/PROJECT_AUDIT_2026-07.md`.
...
- **#298 Спуски у Minetti «слишком лёгкие».** Остаточный эффект уклона поверх GAP положительный —
...
- **#299 Температура датчика часов как второй источник.** `device_summary.avg_temperature_c`
...
- **#301 Аналитика пульса/темпа при отрицательных температурах — после 31.12.2026.**
  ...
  оставить кламп. Заодно сверить Open-Meteo с датчиком часов (#299) на морозе.
- **#300 Температура фиксируется на старте.** Для тренировок 60+ мин брать среднее по часовым
