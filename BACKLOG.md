...
(последняя — 11.09.2026: 275 закрытых строк (274 нумерованных + 139b); нумерация сквозная, следующий свободный номер — #338; 12.09.2026: #335/#336 закрыты, #337 добавлен).
...
**Рекомендуемый порядок первого спринта:** ~~249 → 289 → 308 → 220 → 292+305 → 294 → 295 → 311 → 264 → 263 → 286~~ (закрыты 04.09.2026) → ~~259 + 289~~ (08.09.2026) → ~~253 → 302~~ (08.09) → ~~247 v2 → 237~~ (11.09); по пути 11.09 — ~~#328/#332/#233/#330/#329, #331, #236/#327/#274/#252/#333/#239, аудит 07.2026~~. #243 ждёт даты старта; дальше — P3 по решению владельца (#116, #126, #125, #84/#85) или фичи (#255, #309, #248).
