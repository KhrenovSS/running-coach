...
(последняя — 11.09.2026: 253 закрытых строк; нумерация сквозная, следующий свободный номер — #333).
...
**Рекомендуемый порядок первого спринта:** ~~249 → 289 → 308 → 220 → 292+305 → 294 → 295 → 311~~ → 264 → 263 → 286~~ (закрыты 04.09.2026) → ~~259 + 289~~ (закрыты 08.09.2026); #243 ждёт даты старта; дальше P2: ~~#253 → #302~~ (08.09), #247 v2 → #237; по пути — ~~#328, #329~~ (11.09).
