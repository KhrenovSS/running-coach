...
**Рекомендуемый порядок первого спринта:** ~~249 → 289 → 308 → 220 → 292+305 → 294 → 295 → 311~~ → 264 → 263 → 286~~ (закрыты 04.09.2026) → ~~259 + 289~~ (закрыты 08.09.2026); #243 ждёт даты старта; дальше P2: #253 (решение владельца), #302.
