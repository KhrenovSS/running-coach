...
(последняя — 11.09.2026: 275 закрытых строк (274 нумерованных + 139b); нумерация сквозная, следующий свободный номер — #345; 12.09.2026: #335/#336 закрыты, #337 добавлен; 13.09.2026: #338–#343 добавлены; 16.09.2026: #338–#343 закрыты (потолки объёма в ad-hoc пути), #344 добавлен).
