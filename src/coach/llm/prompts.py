...
- unavailable_days_ahead: список сдвигов дней от «Сейчас» (0 = сегодня … 7), в которые
  подопечный НЕ сможет бегать («в пятницу и воскресенье не смогу»). Система сама снимет
  назначения на эти дни и поставит отдых — не обещай в прозе больше этого и не
  переназначай эти дни. Иначе null.
