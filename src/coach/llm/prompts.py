...
PLAN_PROMPT = (
    ...
    "Заполни weekly_plan: только тренировочные дни (for_days_ahead 1..7 от текущего "
    "дня из «Сейчас», по одному элементу на день), пропущенные дни = отдых, "
    "rest-элементы не включай. Беговых дней НЕ больше run_days_max, дней полного "
    "отдыха не меньше rest_days_min — частота растёт постепенно, а не сразу до "
