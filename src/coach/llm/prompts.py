...
PLAN_PROMPT = (
    ...
    "(build/deload) — НЕ выходи за них и НЕ пересчитывай. Заполни weekly_plan: "
    "только тренировочные дни (for_days_ahead 1..7 от текущего дня из «Сейчас», "
    "по одному элементу на день), пропущенные дни = отдых, rest-элементы не "
    "включай. Распределение — по 80/20 и структуре недели из method_guides "
