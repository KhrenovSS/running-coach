            ...
            if not latest_metrics:
                ...
                if sync_recently:
                    msg = ("🌙 *Нет свежих данных о восстановлении*\n\n"
                           ...
                           "📷 Данные сна (длительность/фазы) Coros в API не отдаёт — "
                           "можешь прислать скриншот экрана сна, я их считаю.")
                else:
                    msg = ("🌙 *Нет данных о восстановлении*\n\n"
                           ...
                           "📷 Можешь прислать скриншот экрана сна из Coros — я считаю "
                           "длительность, фазы и оценку.")
                try:
