...
## Текущее состояние (Session — 02.07.2026, ночь — исправлен баг save_dashboard_data + уведомления Telegram)
...
- [ ] 3Б.1 `sync_service.py` — автосинк отправляет каждую тренировку отдельным сообщением с кнопками 0-10
- [ ] 3Б.2 `uploads.py` — добавить inline-клавиатуру 0-10 в уведомление
- [ ] 3Б.3 `pages.py` — читать TrainingFeedback, передавать rating в шаблон
- [ ] 3Б.4 `session.html` — отображать ⭐ Оценка: X/10
- [ ] 3Б.5 `index.html` — колонка Оценка в таблице тренировок
