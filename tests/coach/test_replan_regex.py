...
@pytest.mark.parametrize("text", [
    ...
    # 03.09.2026: «переделать план» уходило чат-ходом → воскресная строка плана оставалась живой
    "Нужно переделать план на неделю: сегодня в четверг побегать могу, в пятницу не смогу.",
    "переделай план",
    "измени план на неделю",
    "поменяй мне план",
    "скорректируй план недели",
])
...
@pytest.mark.parametrize("text", [
    ...
    "изменилось самочувствие, план держу",
])
