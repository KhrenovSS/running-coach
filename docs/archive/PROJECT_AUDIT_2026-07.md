> **АРХИВ.** Аудит и план рефакторинга 16.07.2026 (v4.1), не ведётся с 03.08.2026. Спринты 1–20c
> и фазы A–D закрыты. Раздел «Модуль аналитики (8 этапов)» ОТМЕНЁН 23.08.2026 — норматив
> `docs/coach/DEV_PLAN.md`. Открытые пункты перенесены в `BACKLOG.md`; таблица отклонённых
> архитектурных предложений (ARC) — в `docs/ARCHITECTURE.md`.
