...
- Многонедельный план не персистится построчно: `coach_messages` c `kind='plan'`; в БД живут
  дневные рекомендации на ближайшие ≤7 дней (`for_days_ahead` в proposal, 29.08.2026 —
  инцидент «воскресный план записан на сегодня»); многонедельный план — по-прежнему только прозой.
