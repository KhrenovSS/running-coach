...
- **Чек-листы C0–C9 и D0–D8 закрыты 25.08.2026. Дальше (§9 DEV_PLAN): гигиена ✅ 29.08
  ...
  (#254, данные сна теперь есть), план к цели/гонке (#243), разбор восстановления между интервалами
  (HRR/`analysis/intervals.py` — «M2.1 разбора», не путать с назначением по сегментам),
  M3 (ПАНО/VDOT — нормативный темп сегментов).**
