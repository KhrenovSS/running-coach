...
- **⏩ ТЕКУЩАЯ ТОЧКА ВОЗОБНОВЛЕНИЯ — допуск объёма по состоянию + диапазон времени (#352/#353), 17.09.2026 поздний вечер**
  ...
  `backup_2026-09-17_10-47-46`). Рабочее дерево чистое, открытой задачи «в процессе» нет. Прод-проверка — TASK §9
  (пт 18.09 утро: «30–35 мин» без «⚠️ урезан»; вс длительная «64–75 мин»). Открыто: #354 (`residual_load` от верха), #350, остаток #243, #349, #344.
