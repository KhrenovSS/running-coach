...
- **Порядок работ — `BACKLOG.md`, раздел «Приоритеты»** (P0 безопасность → P1 нагрузка/планы → P2
  ...
  старта); P2 движется: #247 v2 и #237 закрыты 11.09, дальше — хвосты сегментации #109/#113/#252.
  ...
  #331 (отдых в `/week`), #247 v2 (обрезание прозы), #237 (пересчёт батча после автоподнятия max_hr).
  Следующие кандидаты P2 — хвосты сегментации #109/#113/#252, затем #288/#284/#274; мелочи #333, #327.
