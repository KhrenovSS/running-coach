...
- **Тренировки по сегментам (M2.1, 01.09.2026)**: `WorkoutProposal.segments` +
  ...
  **Решения владельца 02.09.2026:** в карточках — пульс в уд/мин, зона только без max_hr;
...
- **Чек-листы C0–C9 и D0–D8 закрыты 25.08.2026. Дальше (§9 DEV_PLAN): гигиена ✅ 29.08
  ...
  (#254, данные сна теперь есть), план к цели/гонке (#243). **F-серия «сырые данные
...
| История изменений (источник) / история спринтов до 09.2026 | `CHANGELOG.md` / `docs/archive/AGENTS_sprint_history_2026-06-09.md` |
