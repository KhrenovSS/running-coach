...
- **Тренировки по сегментам (M2.1, 01.09.2026)**: `WorkoutProposal.segments` +
  ...
  **Решения владельца 02.09.2026:** в карточках — пульс в уд/мин, зона только без max_hr (исключение 06.09: ускорения 15–20 с — по усилию, «5×20 сек свободно», без потолка пульса);
