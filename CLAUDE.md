...
- **⏩ ТЕКУЩАЯ ТОЧКА ВОЗОБНОВЛЕНИЯ — P0 #338–#343 закрыт 16.09.2026** (`docs/coach/TASK_2026-09-13_athlete_requests.md`
  ...
  тест `long_run_hold`, падает во вторник на `main`). Тем же днём (#345, закоммичено отдельно): объём недели
...
| Просьбы подопечного об изменении тренировки — потолки объёма в чате/утре (#338–#343, ✅ 16.09.2026) | `docs/coach/TASK_2026-09-13_athlete_requests.md` |
