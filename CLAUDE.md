...
- **Порядок работ — `BACKLOG.md`, раздел «Приоритеты»** (P0 безопасность → P1 нагрузка/планы → P2
  ...
  #243 (ждёт даты старта); следующий кандидат — P2: #302 (сегментация коротких
  интервалов на реальном FIT), затем #247 v2 / #237 (#253 закрыт 08.09: набор высоты — гистерезис 2 м).
